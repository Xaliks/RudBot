module.exports = {
    ...
    async execute(bot, player) {
        ...
        message.embeds[0].description = `Следующий трек: *${bot.utils.escapeMarkdown(queue[n].author.tag)}*: **[${bot.utils.escapeMarkdown(track.title)}](https://discord.com/channels/${message.guild.id}/${message.channel.id}/${message.id})** \`[${msToTime(track.length)}]\``
